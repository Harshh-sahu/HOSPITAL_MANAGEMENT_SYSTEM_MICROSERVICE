    ...
    public OpenAPI appointmentOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("v1")
                        .description("Comprehensive APIs for appointments, records, prescriptions, and medicine details")
                        .contact(new Contact().name("HMS Team").email("support@hms.local"))
                        .license(new License().name("Internal Use")))
                .servers(List.of(
                        new Server().url("http://localhost:9200").description("Local Appointment service"),
                ...
                .externalDocs(new ExternalDocumentation()
                        .description("Appointment service API guide")
                        .url("/v3/api-docs"));
    }
}
