package com.hms.MediaMS.config;
...
public class OpenApiCustomizerConfig {
    ...
    private void registerErrorResponseComponents(OpenAPI openApi) {
        ...
        openApi.getComponents().addSchemas("ErrorInfo", new ObjectSchema()
                .addProperty("errorMessage", new io.swagger.v3.oas.models.media.StringSchema().example("File not found"))
                .addProperty("errorCode", new io.swagger.v3.oas.models.media.IntegerSchema().example(404))
        ...
        openApi.getComponents().addResponses("NotFoundResponse", new ApiResponse()
    ...
    private void applyDefaultErrorResponses(OpenAPI openApi) {
        ...
        openApi.getPaths().values().forEach(pathItem -> pathItem.readOperations().forEach(operation -> {
            ...
            responses.putIfAbsent("404", new ApiResponse().$ref("#/components/responses/NotFoundResponse"));
