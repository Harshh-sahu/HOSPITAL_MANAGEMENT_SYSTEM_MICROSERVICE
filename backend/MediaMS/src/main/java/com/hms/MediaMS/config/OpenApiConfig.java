    ...
    public OpenAPI mediaOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("v1")
                        .description("APIs for media upload, retrieval, and file metadata access")
                        .contact(new Contact().name("HMS Team").email("support@hms.local"))
                        .license(new License().name("Internal Use")))
                .servers(List.of(
                        new Server().url("http://localhost:9400").description("Local Media service"),
                ...
                .externalDocs(new ExternalDocumentation()
                        .description("Media service OpenAPI document")
                        .url("/v3/api-docs"));
    }
}
