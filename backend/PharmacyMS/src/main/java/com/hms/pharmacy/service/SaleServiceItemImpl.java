...
return saleItemRepository.save(saleItemDTO.toEntity()).getId();
    ...
    @Override
    public void createMuiltipleSaleItem(Long saleId, Long medicineId, List<SaleItemDTO> saleItemDTOS) throws HmsException {
    ...
    public List<SaleItemDTO> getSaleItemsBySaleId(Long saleId) throws HmsException {
        ...
        return saleItemRepository.findBySaleId(saleId).stream().map(SaleItem::toDTO)
                .toList();
